...
namespace Hx.Gateway.Admin.Authentication;
...
public class JWTEncryption
{
    ...
    private static JWTSettingsOptions JWTSettings = new JWTSettingsOptions();
    /// <summary>
    /// 获取 JWT 配置
    /// </summary>
    /// <returns></returns>
    ...
    {
        return JWTSettingsOptions.SetDefaultJwtSettings(JWTSettings);
    }
    /// <summary>
    /// 获取 JWT 配置
    /// </summary>
    /// <returns></returns>
    public static void BindJWTSetting(IConfiguration configuration)
    {
        configuration.GetSection("JWTSetting").Bind(JWTSettings);
    }
