...
namespace Hx.Gateway.Application.Services.System
{
    ...
    {
        private readonly LoginSettingsOptions _appInfoOptions;
        private readonly SqlSugarRepository<TgUserAccount> _repository;
        public SystemService(SqlSugarRepository<TgUserAccount> repository, IOptionsMonitor<LoginSettingsOptions> optionsMonitor)
        {
