...
namespace QrF.Core.GatewayExtension.Middleware.Pipeline
{
    ...
    {
        public static RequestDelegate BuildExtOcelotPipeline(this IApplicationBuilder app,
            OcelotPipelineConfiguration pipelineConfiguration)
        {
            ...
            app.UseDiffClientRateLimitMiddleware(); // 添加自定义限流中间件
            app.UseCusAuthenticationMiddleware(); // 添加自定义授权中间件
